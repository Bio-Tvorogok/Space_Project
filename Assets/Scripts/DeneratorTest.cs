...
public class DeneratorTest : MonoBehaviour {
	...
	void Start () {
        ...
        /*
        list_vert.Add(new Vector3(2f, 5f, 0));
        list_vert.Add(new Vector3(2f, -5f, 0));
        list_vert.Add(new Vector3(-2f, -5f, 0));
        list_vert.Add(new Vector3(-2f, 5f, 0));*/
